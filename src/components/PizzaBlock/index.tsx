...
const PizzaBlock: React.FC<IPizza> = ({
  ...
  return (
    <div className="herramienta-block-wrapper">
      <div className="herramienta-block">
        <img
          onClick={() => navigate(`/pizza/${_id}`)}
          className="herramienta-block__image"
          src={imageUrl}
          alt="Herramienta"
        />
        <h4 className="herramienta-block__title">{name}</h4>
        <div className="herramienta-block__selector">
          <ul>
            {types.map((type) => (
              <li
                key={type}
        ...
        <div className="herramienta-block__bottom">
          <div className="herramienta-block__price">от {price + activePrice} $</div>
          <div
            role="none"
